...
const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/hortfartura/',
        icon: (props: any) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/hortifruti_fartura/?hl=en',
        icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
  ...
  export default function Footer() {
    return (
      <footer  className=" bg-footer" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl bg-footer">
            ...
            <div className="px-4 mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm font-semibold leading-6 text-white">Para você</h3>
                  <ul role="list" className="mt-6 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold leading-6 text-white">Hortifruti Fartura</h3>
                  <ul role="list" className="mt-6 space-y-4">
          ...
          <div className="mt-5 border-t border-gray-900/10 pt-2 flex justify-center">
            <p className="text-xs leading-5 text-white">&copy; Hortifruti Fartura. Todos os direitos reservados. Desenvolvido por Pedrão</p>
          </div>
        </div>
      </footer>
    )
